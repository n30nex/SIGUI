...
Current public-release status: **not ready to tag**. Live `main` and the last strict-verified merged checkpoint are `0980cc8f8142320b014f9a78cae9cd125f430bcc` (PR #140). Exact-main Actions `29393666190` passed 1,098 host plus 32 checksum tests, five artifacts / 46 entries across 240 files / 75,511,473 bytes, conformance/fuzz, exact-source provenance, and SPDX; receipt SHA-256 is `a912e8d48fab7764e69d2abd053a3623ae257f1b4c7d1c9be61343c367014619`. PR #140 adds strict printable UTF-8 admission, exact retry/retention/reboot/JSON preservation, canonical padded-plaintext validation, and truthful character/byte compose eligibility as a third partial WP-15 software slice, following PR #139's Messages root/Public chat and PR #137's direct-message controller. PR #136 completed the planned WP-14 UI hierarchy/controller extraction in code, but UI-task/lifecycle, 1,000-transition, exact-candidate touch/scroll/focus/keyboard, live BLE/display/radio, WP-14 acceptance, and all release gates remain open. WP-10 route/TRACE/RF, curated emoji/glyph coverage, no-route/contact UI eligibility, degraded/failure/incoming-event Messages states, retained-wall/time physical acceptance, Wi-Fi and Map lifecycle/live acceptance, signed update/recovery, exact-candidate SD/power evidence, and final soaks also remain blockers. Use `include_sd_bridge=false` unless SD/RP2040 evidence changed. No tag may be cut until the exact release-commit gate is green.
