...
Current public-release status: **not ready to tag**. Live `main` and the last strict-verified merged checkpoint are `c50117426956cb8bddd2251e35849069cd5b1044` (PR #137). Exact-main Actions `29389463246` passed 1,090 host plus 32 checksum tests, five artifacts / 46 entries across 222 files / 74,854,241 bytes, conformance/fuzz, exact-source provenance, and SPDX; receipt SHA-256 is `605cc5d8988eb798f4825553314535c5f43ee54993ebddc7cbad7f77cb1bde71`. PR #137 adds a bounded truthful direct-message conversation controller as partial WP-15 software. PR #136 completed the planned WP-14 UI hierarchy/controller extraction in code, but UI-task/lifecycle, 1,000-transition, exact-candidate touch/scroll/focus/keyboard, live BLE/display/radio, WP-14 acceptance, and all release gates remain open. WP-10 route/TRACE/RF, remaining Messages UX, retained-wall/time physical acceptance, Wi-Fi and Map lifecycle/live acceptance, signed update/recovery, exact-candidate SD/power evidence, and final soaks also remain blockers. Use `include_sd_bridge=false` unless SD/RP2040 evidence changed. No tag may be cut until the exact release-commit gate is green.
...
| Direct messages | Partial | DM TX/store/thread UI exists. PR #137 adds an owned retained thread controller with generation guards, directional wrapped bubbles, persisted delivery labels, technical disclosure, revision refresh, mark-read-once, and RF-silent navigation. PR #117 makes the runtime task the sole MeshCore request/TX-completion owner; PR #123 adds authenticated retained PATH learning, current-boot direct DM/ACK dispatch, one bounded flood fallback, and retry-origin truth. Public/default/other channel sections, recent preview/unread truth, compose byte/UTF-8/emoji/send eligibility, identity explanations, bounded search, degraded/retry states, cursor-driven badges, simulator/incoming-event switching, and exact-candidate RF/UI/physical acceptance remain release blockers. |
