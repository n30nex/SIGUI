...
| Touch Home and shell navigation | COM12/Actions-proven | Home uses a full-screen icon launcher with a small title only, colored Time/Wi-Fi/BLE/SD status icons, and no bottom dock; Messages, Nodes, Map, Packets, and Settings keep the bottom dock. PR #40 host/simulator, Actions run `28731948363`, and COM12 `ui_pixel_capture_b2ca00a_actions_28731948363_COM12.json` prove the newest Home pixels; manual physical photos/review are still tracked separately. |
