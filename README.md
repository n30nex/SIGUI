...
Current public-release status: **not ready to tag**. Live `main` and the last strict-verified merged checkpoint are `840ae4874ad204d8fe13a29ca2e832fc0961d155` (PR #139). Exact-main Actions `29391670113` passed 1,094 host plus 32 checksum tests, five artifacts / 46 entries across 228 files / 75,037,120 bytes, conformance/fuzz, exact-source provenance, and SPDX; receipt SHA-256 is `d513bed9bb647a48a01bf57ce7266f99e55a755602ca645d4d479b0940143c0d`. PR #139 adds the bounded Messages root and truthful Public chat hierarchy as a second partial WP-15 software slice, following PR #137's bounded direct-message controller. PR #136 completed the planned WP-14 UI hierarchy/controller extraction in code, but UI-task/lifecycle, 1,000-transition, exact-candidate touch/scroll/focus/keyboard, live BLE/display/radio, WP-14 acceptance, and all release gates remain open. WP-10 route/TRACE/RF, compose/UTF-8 and degraded/failure Messages states, retained-wall/time physical acceptance, Wi-Fi and Map lifecycle/live acceptance, signed update/recovery, exact-candidate SD/power evidence, and final soaks also remain blockers. Use `include_sd_bridge=false` unless SD/RP2040 evidence changed. No tag may be cut until the exact release-commit gate is green.
...
| Touch Home and shell navigation | Partial | Home is a quiet dashboard with Messages, Network, Map, and More destinations plus one Device status card. Non-Home pages use the matching five-item dock; Packets, diagnostics, connections, storage, and device settings live under More. PRs #125/#127/#129 extract Home, More, and read-only/no-format Storage truth; PRs #130/#131 own the Wi-Fi and Map setup sheets; PRs #132/#133/#135 own the BLE setup, Display/Diagnostics, and Radio Settings sheets; PR #136 completes the planned hierarchy/controller extraction with bounded Contact sheets. Exact-main software/artifact evidence is banked. UI-task-only LVGL proof, lifecycle/open-close proof, 1,000 transitions, exact-candidate touch/scroll/focus/keyboard qualification, and the required runtime-safety artifact remain open, as do live BLE/display/radio behavior and downstream feature acceptance. |
...
| Messages and direct messages | Partial | PR #139 adds the Messages root with Public/Direct destinations and a truthful retained Public conversation with directional wrapped bubbles, Public-only read-cursor advancement, RF-silent hierarchy navigation, and `Sent over RF` only after retained TxDone. PR #137 adds the owned retained DM thread controller with persisted delivery labels, technical disclosure, revision refresh, and mark-read-once; PR #117/#123 provide runtime-owned delivery and authenticated retained-path/fallback foundations. Compose byte/UTF-8/emoji/send eligibility, sender-to-DM identity explanations, bounded search and degraded/failure/retry states, trusted wall-time display, cursor-driven badges, simulator/incoming-event switching, controlled-peer delivery, and exact-candidate RF/UI/physical acceptance remain release blockers. |
