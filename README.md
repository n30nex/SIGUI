...
Current public-release status: **not ready to tag**. Exact main `f95b2fc73a29cb3292036786c846308a2bf76080` through PR #180 is strict-banked by Actions `29545499539`: 1,256 host plus 33 checksum tests, 1,008 wire vectors, 931 oracle checks, 100,000 wire plus 100,000 advert and 200,000 USB-parser fuzz executions with zero findings, and five artifacts / 46 entries across 340 files pass; canonical receipt SHA-256 is `3fca0071ca10845f0aa37eb9124a7d3a147261ed9ff158c1659b4164ad0b6d8e`. PRs #177-#180 bank signed-advert replay parity, canonical packet-hash authority, bounded USB command parsing/fuzzing, exact-session ACK completion, durability-first effects, explicit lifetimes, and boot-local reachability. The truthful WP-05 matrix is 11 implemented / 5 partial / 0 missing semantic requirements across 11 suites / 77 scenarios; fuzz is 3 implemented / 1 partial / 4 missing. Official-peer RF, physical acceptance, full WP-05, and release closure remain open. Reporting remains 80% capability implementation, 74% weighted release progress, and 0 of 11 final gates green. Use `include_sd_bridge=false` unless SD/RP2040 evidence changed. No tag may be cut until the exact release-commit gate is green.
