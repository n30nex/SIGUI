...
Current public-release status: **not ready to tag**. Live `main` and the last strict-verified merged checkpoint are `526f7110ec0cba589681f6c73fa499abfe72db56` (PR #136). Exact-main Actions `29388000211` passed 1,085 host plus 32 checksum tests, five artifacts / 46 entries across 219 files / 74,715,707 bytes, conformance/fuzz, exact-source provenance, and SPDX; receipt SHA-256 is `06ce2689da51933e99b4c3222f0714af1f4a639974ba4d779ffb171f3a68ead2`. PR #136's Contact sheets aggregate completes the planned WP-14 UI hierarchy/controller extraction in code, but it does not close UI-task/lifecycle, 1,000-transition, exact-candidate touch/scroll/focus/keyboard, live BLE/display/radio, WP-14 acceptance, or any release gate. WP-10 route/TRACE/RF, retained-wall/time physical acceptance, Wi-Fi and Map lifecycle/live acceptance, signed update/recovery, exact-candidate SD/power evidence, and final soaks also remain blockers. Use `include_sd_bridge=false` unless SD/RP2040 evidence changed. No tag may be cut until the exact release-commit gate is green.
