...
- MeshCore Public group text TX/RX is implemented and validated through the serial console, but full MeshCore C++ identity, advert, DM, contacts, route, and store integration is still pending.
