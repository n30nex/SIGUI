...
Release status: the expanded exact-main Actions dry audit reports `ready_for_public_release=false`, with **33 remaining P0 failures and 35 failures overall including P1**. A downloaded exact-input recheck passes six scoped gates and leaves 28 P0 / 30 overall failures. `scripts/release_gate_audit_d1l.py` must report `ready_for_public_release=true` for the exact release commit before tagging; older evidence or individually passing branches cannot close that gate.

Execution checkpoint: live `main` is `ee520984d2209ae7419c02bb46d57c1549eeb56c` after PR #97 merged the fail-closed exact ESP-IDF version receipt on top of PR #96's production/oracle/runtime defined-arithmetic Ed25519 integration. Exact merged-main Actions `29313013731` passed 935 host tests plus 32 checksum-contract tests; all five API ZIPs and 46 nested entries strict-passed across 219 files / 72,428,299 bytes with inventory `b3eac68f12ab9fd7192319a3bfdfac56c9104f8d0a5a5f8b7c416e8e838cc606`. The 15-byte `idf-version.txt` is exactly `ESP-IDF v5.5.4` plus LF and nonzero capture mutations remain audit-invalid. Portable aggregates are `docs/completion/evidence/wp04/production_oracle_ed25519_integration_83a811247aa79a379ee810da7489c90c62112fee.json` (SHA-256 `d75c1f948784faecb07b49ed423732542e91bc3947f68e76f831dad0413521f2`) and `docs/completion/evidence/wp24/idf_version_receipt_ee520984d2209ae7419c02bb46d57c1549eeb56c.json` (SHA-256 `f21abb17403f432c17bf19cc052cd185b05a39c705a3a984e73f5fcb6a547fa5`). WP-03 remains banked; WP-04 is in progress. Draft PR #98 at exact head `d44e9c95f8e2b5a03366ab905782e6170057d606` implements schema-v5 durable inbound-DM ACK correlation and is running exact Actions while route selection is rebased behind it. WP-01 remains banked on `092293f`; WP-02 physical qualification remains open for five frozen-candidate roles. [COMPLETION_LEDGER.yaml](COMPLETION_LEDGER.yaml) remains the machine-readable execution source, with [COMPLETION_STATUS.md](COMPLETION_STATUS.md) as its generated view.
...
1. PRs #62, #64, #80, and #84-#97 are merged on exact `main` `ee520984d2209ae7419c02bb46d57c1549eeb56c`; WP-03 reproducibility proof is banked, WP-04 production/oracle Ed25519 integration is merged, and the exact IDF-version receipt defect is closed.
2. Exact merged-main Actions `29313013731` built the applicable ESP32/package inputs and strict-passed 3 downloaded manifests / 46 entries; the full RP2040-inclusive integration baseline remains `4ee07caf` / `29290978741` at 8 manifests / 78 entries. Continue WP-04 through exact PR #98 while the five WP-02 physical roles remain explicitly deferred to the frozen final candidate; green builds do not substitute for physical proof.
...
real signed-advert Identity/Mesh/Dispatcher/BaseChatMesh execution; and PR #96
selected the overlay in production/oracle/runtime/package with zero exceptions.
The current receipt remains `closure_ready=false`: ACK, route, TRACE, admin,
retained-state, real-peer RF, and physical proof are still open. See
...
WP-01's exact-pair proof is banked. The integration, release-security, WP-04 Ed25519, and exact-IDF-receipt slices through PR #97 are merged on live `main` `ee520984d2209ae7419c02bb46d57c1549eeb56c`; exact merged-main Actions/checksums and WP-03 reproducibility proof pass. The tracked, repository-relative WP-02 baseline at `docs/completion/evidence/wp02/integration_baseline_4ee07caf09906abdcebe8faccd95790dceb5fe88.json` has SHA-256 `39d8632d6de5bc819a96e92e970b9d280130a3014336be5d045a1f3fe07b654c` and fails closed only on five missing physical roles. Keep that receipt open without stalling WP-04, and collect those roles once on the frozen final candidate. Draft PR #98 is the current exact schema-v5 ACK durability slice; route selection follows it. The earlier PR #80 `341a3abf4db4c52acf5859e396f25e7adb4cbab1` result is rehearsal history only.
...
4. Continue #65 from the merged production-cryptography boundary into ACK/ACK+PATH, PATH/trace, duplicate/replay, and retained-state transitions. Keep `closure_ready=false` until the entire declared surface is proven against the pinned implementation.
