...
1. Continue #16/#6 UI modular ownership slices from the owned Home renderer toward explicit-root screen modules, modal exclusivity, and UI-task command ownership.
