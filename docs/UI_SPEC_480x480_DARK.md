...
- Public message screen with persisted recent Public rows and a touch `test` send action routed through the app model.
...
- Full Public chat composer and deeper scrollback/search.
- DMs.
