...
**Live reconciliation, 2026-07-16:** live and last strict-banked main is PR #168 at `c88b341abdddb87913ca6b0443804547acadca16`. Exact-main Actions `29515366961` pass 1,196 host, 32 checksum, 1,008 wire-vector, 931 oracle, 100,000 wire-fuzz, and 100,000 advert-fuzz checks with zero findings. All five API ZIPs and 46 nested checksum entries verify across 339 files / 80,205,061 bytes with exact-source provenance and SPDX; strict receipt SHA-256 is `254ca1982f343c74d8d78c3afd6e42f9cfa02a0447d1bb8e2afdf8353e34c1eb`, and gate-manifest SHA-256 is `d42a65c887e480f99220c4448bdc7e1c6e30b0b621aa3e7ad9ad1d6e166b90d4`. PR #167 banks explicit fail-closed legacy `mesh_ts` migration; portable WP-12 aggregate SHA-256 is `550b621bb91016037d8ec8f62018285006867e7542288cc3832d818b8999ad9e`. PR #168 closes the P2 Admin direct-response derivation/session-invalidation gap and banks contact-targeted one-byte TRACE; portable WP-04/WP-10/WP-18 aggregate SHA-256 is `48cedc8dddd9dc21d8cc86c7b44816c808ca123d341408c1cabd39ca22cca615`. Multi-byte/multi-hop TRACE, TRACE UI, room administration, mutations, Admin UI, controlled-peer RF, exact-candidate hardware/time acceptance, required acceptance artifacts, dependency closure, WP-04/WP-10/WP-12/WP-18, and release closure remain open. The strict audit remains fail-closed with 33 P0 / 35 total failures; capability reporting remains 80.3703703704% raw / 80% reported, weighted progress remains 74.2962962963% raw / 74% reported, final gates remain 0 of 11 green, and provenance is valid but unauthenticated with no SLSA level claimed.
...
**Live partial evidence:** PR #165 head `801614311366d8274116e19599ddb6a0430fd454`, retained synthetic merge `0ccaf23429ce63537a5afa95db46fd3ec001ebc9`, and exact main `0eee2ce4032911e8b133d5a13ea8dc1715385a4b` share tree `e39266e9dda7e73024bd5f5b3380c7945c55a297`. Retained PR Actions `29509909934` and exact-main Actions `29510935869` pass; PR/main receipt SHA-256 values are `7cedffeba927fc4ac2ec3695c46c6000fe128ad484094f10cfb6cc6a91f61db3` and `d960e58090f993445249211aace78c37350c56578c549ed4fab8b5f9e0b3ab18`, exact-main gate-manifest SHA-256 is `3e68573ca2928f9a0182e0fa8b70552a64d8b36326575ea7a0b66b9bcb26c489`, and portable aggregate `node_role_summary_0eee2ce4032911e8b133d5a13ea8dc1715385a4b.json` has SHA-256 `c0358a33cfd327e7cb448d7307e9ca3044f851d522df11450d812d71340a4119`. This banks exact, bounded role totals from rendered node rows only. Remaining Node detail/actions, signed Map pins, real trace/network tools, max-record live-update responsiveness, exact-candidate physical Nodes/Map proof, dependencies, the required artifact, and WP-16 closure remain open.
