...
**Live reconciliation, 2026-07-16:** exact main through PR #180 is `f95b2fc73a29cb3292036786c846308a2bf76080`. Exact-main Actions `29545499539` pass 1,256 host, 33 checksum, 1,008 wire-vector, 931 oracle, 100,000 wire-fuzz, 100,000 advert-fuzz, and 200,000 USB-parser fuzz checks with zero findings. All five API ZIPs and 46 nested checksum entries verify across 340 files / 81,445,758 bytes with exact-source provenance and SPDX 2.3; canonical strict receipt SHA-256 is `3fca0071ca10845f0aa37eb9124a7d3a147261ed9ff158c1659b4164ad0b6d8e`, and gate-manifest SHA-256 is `1bcc28bcf09bbee43ee772873c6568a828d38480f828766316492a96f8c3d4a1`. PRs #177-#180 bank signed-advert replay parity, canonical packet-hash authority, bounded USB command parsing/fuzzing, exact-session ACK completion, durability-first effects, explicit lifetimes, and boot-local reachability. The WP-05 matrix is 11 implemented / 5 partial / 0 missing semantic requirements with 11 suites / 77 scenarios; fuzz is 3 implemented / 1 partial / 4 missing. Earlier banks remain preserved. Official-peer RF, physical acceptance, full WP-05, and release closure remain open. The strict audit remains fail-closed with 33 P0 / 35 total failures; capability reporting remains 80.3703703704% raw / 80%, weighted progress 74.2962962963% raw / 74%, and final gates 0 of 11 green.
