...
**Live reconciliation, 2026-07-15:** live main is merged and strict-banked through PR #155 at `eaea26f253d206b7b0d675cba32870cb7a9d856a`. Exact-main Actions `29448520278` pass 1,145 host, 32 checksum, 1,008 wire-vector, 931 oracle, 100,000 wire-fuzz, and 100,000 advert-fuzz checks with zero findings. All five API ZIPs and 46 nested checksum entries verify across 339 files / 79,125,592 bytes with exact-source provenance and SPDX; strict receipt SHA-256 is `02512742d1610f481c9eff08db40f7f58ccd5e1c3f4f649d7312e0cff4c3b059`, and gate-manifest SHA-256 is `917c6660127cc88a7304770d90c35e6e8c25c6653dac37710715cdbb011dae97`. PR #152 banks selected-channel runtime/storage, PR #153 adds truthful channel conversation UI, PR #154 adds boot-local NVS telemetry, and PR #155 adds a redacted confirmation-gated channel management app boundary. Secure New/Import/Manage sheets, pinned official-client RF interoperability, exact-candidate reboot/reset/recovery and physical qualification, `channel_acceptance_<sha>.json`, WP-09 closure, and release closure remain open. The release audit remains fail-closed with 33 P0 / 35 total failures; unauthenticated provenance claims no SLSA level.
...
**Live partial evidence:** PR #114 banks the bounded durable Public-plus-seven channel model, PR #116 banks atomic redacted metadata/selection through the app/USB boundary, and PR #152 banks selected-channel runtime/storage at exact main `922b1158c4304848d9ece75cb43145159f5355ba`. Its exact-main Actions `29445202940`, receipt SHA-256 `a4c9d17636f027cc02212ea68ba2ef0c281313f566b63eb8e9aa688d9c5153d3`, gate-manifest SHA-256 `f6cb17c7ab984d977b43daa54861e0d3496e02837ccd41d34f8044cc521ef9db`, and portable aggregate SHA-256 `dac0d1dc0720f1b00f84b2208950305f54f94ba5e006dbc43fa77c3512c803e5` pass. PRs #153-#155 then add truthful channel conversations and the redacted confirmation-gated management app boundary. The combined exact-main checkpoint `eaea26f253d206b7b0d675cba32870cb7a9d856a` / Actions `29448520278` is strict-banked by receipt SHA-256 `02512742d1610f481c9eff08db40f7f58ccd5e1c3f4f649d7312e0cff4c3b059` and gate-manifest SHA-256 `917c6660127cc88a7304770d90c35e6e8c25c6653dac37710715cdbb011dae97`. Secure management sheets, official-client bidirectional RF, exact-candidate reboot/reset/recovery and physical evidence, the required acceptance artifact, dependency closure, WP-09 closure, and release closure remain open.
