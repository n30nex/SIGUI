...
**Live reconciliation, 2026-07-16:** live main is merged and strict-banked through PR #162 at `aeb538088bada27fa8f84882b05a641fb944bc90`. Exact-main Actions `29463374435` pass 1,178 host, 32 checksum, 74 focused timezone/settings/UI, 1,008 wire-vector, 931 oracle, 100,000 wire-fuzz, and 100,000 advert-fuzz checks with zero findings. All five API ZIPs and 46 nested checksum entries verify across 339 files / 79,854,874 bytes with exact-source provenance and SPDX; strict receipt SHA-256 is `7da9d5fa09a3e0a7b7e73db23aa483e0c1214bfa06b0e7a592e1dd5814ab9af9`, and gate-manifest SHA-256 is `ab94aaf8ad1f03a32d67f923d2c6a23ab5789fee1b2d6939b300298b220d8e66`. PR #161 banks fail-closed completion reporting and gate parsing. PR #162 banks fixed UTC offsets from UTC-12:00 through UTC+14:00, minute offsets, schema-v8 migration, truthful USB/UI state, overflow-safe display conversion, and UTC-only protocol/certificate clocks; portable WP-12 aggregate SHA-256 is `c774398c115abd6c390c2fdfd2dec45e1bf259650012005013e04d127c776f06`. Legacy `mesh_ts` migration, authenticated companion transport, full-reset/power-loss/endurance durability, physical time/UI/RF qualification, Home status icons, UI-task/lifecycle/1,000-transition qualification, required acceptance artifacts, exact-candidate reboot/reset/recovery, dependency closure, WP-09/WP-11/WP-12/WP-14, and release closure remain open. The release audit remains fail-closed with 33 P0 / 35 total failures; capability reporting remains 80.3703703704% raw / 80% reported, weighted progress remains 74.2962962963% raw / 74% reported, final gates remain 0 of 11 green, and provenance is valid but unauthenticated with no SLSA level claimed.
