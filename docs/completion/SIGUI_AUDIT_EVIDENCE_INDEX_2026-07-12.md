...
| Item | Value |
|---|---|
| Live merged main | `c50117426956cb8bddd2251e35849069cd5b1044`; exact-main Actions `29389463246` green |
| Last strict-verified merged checkpoint included in this pack | `c50117426956cb8bddd2251e35849069cd5b1044` / Actions `29389463246` / receipt `605cc5d8988eb798f4825553314535c5f43ee54993ebddc7cbad7f77cb1bde71` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#137 are merged and strict-banked; PR #137 banks bounded direct-message conversation ownership as the first partial WP-15 slice, while PR #136 completed the planned WP-14 hierarchy/controller extraction in code |
| Candidate integration state | Exact evidence through PR #137 adds partial WP-15 direct-message conversation software atop completed planned WP-14 hierarchy/controller code, banked WP-12, and partial WP-13 slices. Remaining Messages UX, UI-task/lifecycle/1,000-transition/exact-device acceptance, controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, live BLE/display/radio behavior, remaining Wi-Fi and Map lifecycle/live acceptance, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29389463246` passed 1,090 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | At exact main `c501174`, five ZIPs / 46 entries strict-verified across 222 files / 74,854,241 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `605cc5d8988eb798f4825553314535c5f43ee54993ebddc7cbad7f77cb1bde71` |
| Conformance closure | false; PR #137 adds partial WP-15 direct-message conversation software and PR #136 completes planned WP-14 hierarchy/controller code. Remaining Messages UX, exact-candidate UI-task/lifecycle/transition/physical acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; exact-main audit SHA-256 `2d47932531e2ff4f261e341ccbe5fa276247f8210b1ce396b5770b3268ef02db` is fail-closed with 33 P0 / 35 overall |
