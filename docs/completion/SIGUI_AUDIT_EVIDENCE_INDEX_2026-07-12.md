...
| Item | Value |
|---|---|
| Last strict-verified merged checkpoint | `bd201a1fa561d67082012c6ebec0e0e554e60e58` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Active PR stack | No open pull requests at this snapshot; PRs #120 and #121 are merged and exact-main evidence is banked through #121 |
| Candidate integration state | PRs #62, #64, #80, #84-#99, #101-#118, #120, and #121 are merged at the strict-verified checkpoint; exact evidence now includes the first WP-12 truthful-time foundation and fourth WP-14 connectivity-view slice, while trusted time admission/migration/recovery, live connectivity, complete semantic/runtime/UI ownership, RF, and physical closure remain open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29374390847` passed 1,026 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | Five ZIPs / 46 entries strict-verified across 219 files / 73,786,407 bytes with valid provenance and SPDX; strict receipt SHA-256 `3d06276cbfca0566e0625baaa1189406f3c6cae45b50d2a50477486143ec0733` |
| Conformance closure | false; truthful-time and connectivity-view foundations join the earlier partial slices, while trusted SNTP/protocol admission, time migration/recovery, WP-07 exact-candidate RF/DM/recovery/UI/physical acceptance, WP-11 durability completion, channel runtime/UI/interoperability/RF, remaining UI ownership, BLE, admin, generic TRACE, real-peer RF, and physical proof remain |
| Release status | not ready to tag; exact checkpoint audit SHA-256 `c06fff49430e2d08f83c30a90f17e1ea3ec545dfdd22c7c25dadca2401a0b7f9` is fail-closed with 33 P0 / 35 overall |
