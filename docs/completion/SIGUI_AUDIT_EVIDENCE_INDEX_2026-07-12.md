...
| Item | Value |
|---|---|
| Live merged `main` | `b49a7b3a18379fdb6e4fe95c46784e8e2ea79d2e` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Active PR stack | draft PR #95 head `2acd0f2f01542e7bb5e9638d403fb43e216bfab1` (WP-04 ledger); Ed25519 integration and ACK dispatch branches are in implementation |
| Candidate integration state | PRs #62, #64, #80, #84-#94 are merged; WP-03 proof is banked, WP-04 signed-advert and Ed25519 overlay foundations are merged/in progress, and frozen-candidate physical qualification remains open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | 917 passing tests in exact-main Actions `29307595930`; 914 in each PR #93 push/merge-test run |
| Candidate CI | Exact main and PR #93 runs are green; signed-advert runtime, conformance/fuzz, ESP32 firmware, package, SBOM, provenance, and downloaded checksums pass |
| Conformance closure | false; signed-advert runtime is merged, while Ed25519 production integration, ACK, route, TRACE, admin, retained-state, and real-peer proof remain |
