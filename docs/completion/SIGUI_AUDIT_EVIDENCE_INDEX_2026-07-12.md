...
| Item | Value |
|---|---|
| Live merged main | `404a2fa9e3b28b86d3118920753c85fdd5e0e95e` through PR #157; exact-main Actions `29452355824` and strict downloaded-artifact gate pass |
| Last strict-verified merged checkpoint included in this pack | `404a2fa9e3b28b86d3118920753c85fdd5e0e95e` / Actions `29452355824` / receipt `35319a7b0a5e7e527846121e8bc30f6456532650b816fd7026e4b01c17be4144` / gate manifest `57ff3427cabf3ebbfd169db6cb99202763748ca39e70e536a6e42e69f687e045` |
...
| Merged completion slices | PR #152 banks WP-09 selected-channel runtime/storage, PR #153 merges truthful channel conversations, PR #154 merges boot-local NVS telemetry, PR #155 merges the redacted confirmation-gated channel management app boundary, PR #156 banks the portable runtime evidence, and PR #157 merges secure channel-management sheets plus a fail-closed hardware-entropy-backed DRBG. No physical/RF/WP-09/WP-11/release closure is inferred |
| Candidate integration state | Exact main `404a2fa` has channel identity across retained history/unread, selected-channel TX/RX, pending-operation completion, reboot/rollback/eviction/hot-SD software reconciliation, Public compatibility, conversation UI, NVS telemetry, the management app boundary, secure New/Import/Manage/QR sheets, and secure entropy-backed channel/identity generation. Official-client RF, exact-candidate reboot/reset/recovery and physical UI qualification, `channel_acceptance_<sha>.json`, dependency closure, WP-09 closure, and release closure remain open |
...
| Last banked candidate CI | At exact main `404a2fa`, five ZIPs / 46 entries strict-verified across 339 files / 79,439,771 bytes with 1,158 host, 32 checksum, 33 focused security tests, 74 oracle pins, exact-source provenance, and SPDX; strict receipt SHA-256 `35319a7b0a5e7e527846121e8bc30f6456532650b816fd7026e4b01c17be4144`. Provenance is unauthenticated and no SLSA level is claimed |
| Conformance closure | false overall; this pack admits the strict-banked software stack through PR #157, including secure channel-management sheets and the fail-closed entropy service. Pinned official-client RF, exact-candidate reboot/reset/recovery and physical UI acceptance, the required channel artifact, controlled-peer route/TRACE, real RF fallback, multi-hop, retained-time physical gates, remaining Wi-Fi/Map/BLE/display/radio acceptance, WP-07, WP-11, admin, and final release closure remain open |
| Release status | not ready to tag; the `404a2fa` dry audit SHA-256 `154bb5cbb7ccb68d52640cb634cf754ee0c59a4aaf910d377b09467c4865af3c` is fail-closed with 33 P0 / 35 overall |
