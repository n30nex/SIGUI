...
| Item | Value |
|---|---|
| Live merged main | `526f7110ec0cba589681f6c73fa499abfe72db56`; exact-main Actions `29388000211` green |
| Last strict-verified merged checkpoint included in this pack | `526f7110ec0cba589681f6c73fa499abfe72db56` / Actions `29388000211` / receipt `06ce2689da51933e99b4c3222f0714af1f4a639974ba4d779ffb171f3a68ead2` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#136 are merged and strict-banked; PR #136 banks bounded Contact sheets ownership and completes the planned WP-14 hierarchy/controller extraction in code |
| Candidate integration state | Exact evidence through PR #136 completes planned WP-14 hierarchy/controller code atop banked WP-12 and partial WP-13 slices. UI-task/lifecycle/1,000-transition/exact-device acceptance, controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, live BLE/display/radio behavior, remaining Wi-Fi and Map lifecycle/live acceptance, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29388000211` passed 1,085 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | At exact main `526f711`, five ZIPs / 46 entries strict-verified across 219 files / 74,715,707 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `06ce2689da51933e99b4c3222f0714af1f4a639974ba4d779ffb171f3a68ead2` |
| Conformance closure | false; PR #136 completes planned WP-14 hierarchy/controller code. Exact-candidate UI-task/lifecycle/transition/physical acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; exact-main audit SHA-256 `6d19cb1122f44d4e40846c4527a30406e8daebde67507909e090536918d967f4` is fail-closed with 33 P0 / 35 overall |
