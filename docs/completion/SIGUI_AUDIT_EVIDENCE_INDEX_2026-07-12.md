...
| Item | Value |
|---|---|
| Live merged main | `f61d40385594284f9e9f15a92bba81770c8fd24d` (PR #132); exact-main Actions `29385596543` green, with its strict receipt reserved for the next evidence-bank slice |
...
| Merged completion slices | PRs #123-#131 are merged and strict-banked through `2bba1b6`; PR #130 banks the owned Wi-Fi setup controller and PR #131 banks the owned Map setup controller |
| Candidate integration state | Exact evidence through PR #131 adds bounded Map setup ownership to the banked WP-12, partial WP-13, and earlier WP-14 slices. Controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, remaining Wi-Fi and Map lifecycle/live acceptance, full runtime/UI ownership, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29384981503` passed 1,063 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | At exact main `2bba1b6`, five ZIPs / 46 entries strict-verified across 219 files / 74,403,293 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `86f5bed6b506a1a2ebce9dc701bba33ba428560fef7a5b8f7fa8038d1ad5191d` |
| Conformance closure | false; PR #128 banks the Wi-Fi crash guard, PR #129 banks bounded Storage truth, PR #130 banks bounded Wi-Fi setup ownership, and PR #131 banks bounded Map setup ownership. Exact-candidate controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, remaining UI ownership, BLE, and admin remain open |
| Release status | not ready to tag; exact-main audit SHA-256 `110e46bf886b96bc873c0523d296382e758823391190f1d01494d990b9c4495e` is fail-closed with 33 P0 / 35 overall |
