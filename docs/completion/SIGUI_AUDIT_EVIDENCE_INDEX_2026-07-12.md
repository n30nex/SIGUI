...
| Item | Value |
|---|---|
| Live merged main | `c20d5b4580188fe86d1607845050f08aa37fec24`; exact-main Actions `29438968424`, strict receipt `051cef8cd7aaab4b6d1302bca379c39e207dd0651378aa59eef2fd02aff916c7`, and gate manifest `1115a8829774837a72f580ee63de8ddd571282fb1ee4d31f8b6ee6f4e92fe004` green and banked |
| Last strict-verified merged checkpoint included in this pack | `c20d5b4580188fe86d1607845050f08aa37fec24` / Actions `29438968424` / receipt `051cef8cd7aaab4b6d1302bca379c39e207dd0651378aa59eef2fd02aff916c7` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#150 are merged and strict-banked where applicable; PR #150 completes the bounded WP-15 software-behavior implementation with transactional read cursors and context-preserving incoming refresh, PR #149 banks truthful retained/live state presentation, and PR #147 banks fail-closed sender-to-DM identity eligibility/explanations. Evidence-only PRs between implementation merges do not broaden feature closure |
| Candidate integration state | Live main contains the scoped WP-15 Messages software implementation: hierarchy, truthful Public/DM presentation and delivery state, UTF-8 admission, compose eligibility/retry, bounded retained search, exact identity eligibility/explanations, degraded/no-contact states, transactional relevant-cursor advancement, and RF-silent incoming refresh with default/large simulator coverage. WP-15 still needs dependency closure, controlled-peer RF, exact-candidate physical touch/keyboard/scroll/UTF-8 proof, and `messages_ui_acceptance_<sha>_<d1l>.json`; curated emoji/glyph/notifications/accessibility/polish belongs to WP-21. UI-task/lifecycle/1,000-transition acceptance, route/TRACE, multi-hop/RF, retained-time physical, live BLE/display/radio, Wi-Fi/Map lifecycle, physical SD/UI, and release closure remain open |
...
| SDK | ESP-IDF 5.5.4 |
| Last banked host suite | Exact-main Actions `29438968424` passed 1,131 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Last banked candidate CI | At exact main `c20d5b4`, five ZIPs / 46 entries strict-verified across 318 files / 78,205,601 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `051cef8cd7aaab4b6d1302bca379c39e207dd0651378aa59eef2fd02aff916c7`. Provenance is unauthenticated and no SLSA level is claimed |
| Conformance closure | false overall; this pack banks WP-15 software-behavior completion through PR #150, while its physical/RF/required acceptance gates remain open. Exact-candidate UI-task/lifecycle/transition acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; live-main audit SHA-256 `43b2eba88dca850d32cb56307b28fc6950ce841972a8dcb45b641565e32bfe41` is fail-closed with 33 P0 / 35 overall |
