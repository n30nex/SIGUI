...
| Item | Value |
|---|---|
| Live merged main | `242c5aa455cbbe9bf0b1b4cbfe4aa8bb8e52ab7f`; exact-main Actions `29432646761` and strict receipt `3626b8bf73ff584977811f841f0d9c79360da053ec351aab129a27311f435d23` green and banked |
| Last strict-verified merged checkpoint included in this pack | `242c5aa455cbbe9bf0b1b4cbfe4aa8bb8e52ab7f` / Actions `29432646761` / receipt `3626b8bf73ff584977811f841f0d9c79360da053ec351aab129a27311f435d23` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#145 are merged and strict-banked where applicable; PR #145 banks bounded retained DM search as the sixth partial WP-15 slice, PR #144 banks live compose eligibility/recoverable send failure as the fifth, PR #142 banks truthful DM conversation projection as the fourth, PR #140 banks strict UTF-8 text admission, PR #139 banks Messages root/Public chat, and PR #137 banks the direct-message controller. Evidence-only PRs between implementation merges do not broaden feature closure |
| Candidate integration state | Live main includes fail-closed Public/DM compose eligibility, explicit recoverable retry with failed-draft retention, and bounded exact-fingerprint retained DM search with truthful empty/no-match states on top of the prior conversation projection, UTF-8, Public chat, and DM controller slices. Curated emoji/glyph coverage, sender-to-DM identity explanations, loading/storage-degraded/no-contact and remaining failure/retry states, trusted time, remaining badge/incoming-event and simulator flows, UI-task/lifecycle/1,000-transition/exact-device acceptance, controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, live BLE/display/radio behavior, remaining Wi-Fi and Map lifecycle/live acceptance, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Last banked host suite | Exact-main Actions `29432646761` passed 1,113 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Last banked candidate CI | At exact main `242c5aa`, five ZIPs / 46 entries strict-verified across 270 files / 76,522,285 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `3626b8bf73ff584977811f841f0d9c79360da053ec351aab129a27311f435d23` |
| Conformance closure | false; this pack banks PR #144 compose eligibility/recoverable send failure and PR #145 bounded retained DM search as the fifth and sixth partial WP-15 software/artifact slices. Remaining Messages UX, exact-candidate UI-task/lifecycle/transition/physical acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; live-main audit SHA-256 `7d159cba9aafe282fa265883c2ff2930ba2f461fb03c9331c6103d67c6e7a6d0` is fail-closed with 33 P0 / 35 overall |
