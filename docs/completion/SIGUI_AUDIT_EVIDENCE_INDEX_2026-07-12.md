...
| Item | Value |
|---|---|
| Live merged main | `eaea26f253d206b7b0d675cba32870cb7a9d856a` through PR #155; exact-main Actions `29448520278` and strict downloaded-artifact gate pass |
| Last strict-verified merged checkpoint included in this pack | `eaea26f253d206b7b0d675cba32870cb7a9d856a` / Actions `29448520278` / receipt `02512742d1610f481c9eff08db40f7f58ccd5e1c3f4f649d7312e0cff4c3b059` / gate manifest `917c6660127cc88a7304770d90c35e6e8c25c6653dac37710715cdbb011dae97` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | PR #156 (`codex/wp09-runtime-postmerge-evidence`); the secure channel-management sheets slice is committed locally and not yet opened |
| Merged completion slices | PR #152 banks WP-09 selected-channel runtime/storage, PR #153 merges truthful channel conversations, PR #154 merges boot-local NVS telemetry, and PR #155 merges the redacted confirmation-gated channel management app boundary. No physical/RF/WP-09/WP-11/release closure is inferred |
| Candidate integration state | Exact main `eaea26f` has channel identity across retained history/unread, selected-channel TX/RX, pending-operation completion, reboot/rollback/eviction/hot-SD software reconciliation, Public compatibility, conversation UI, NVS telemetry, and the management app boundary. Secure management sheets, official-client RF, exact-candidate reboot/reset/recovery and physical qualification, `channel_acceptance_<sha>.json`, dependency closure, WP-09 closure, and release closure remain open |
...
| SDK | ESP-IDF 5.5.4 |
| Last banked host suite | Exact-main Actions `29448520278` passed 1,145 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Last banked candidate CI | At exact main `eaea26f`, five ZIPs / 46 entries strict-verified across 339 files / 79,125,592 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `02512742d1610f481c9eff08db40f7f58ccd5e1c3f4f649d7312e0cff4c3b059`. Provenance is unauthenticated and no SLSA level is claimed |
| Conformance closure | false overall; this pack admits the strict-banked software stack through PR #155: WP-09 runtime/storage, channel conversations, retained-NVS telemetry, and the management app boundary. Secure management sheets, pinned official-client RF, exact-candidate reboot/reset/recovery and physical acceptance, the required channel artifact, controlled-peer route/TRACE, real RF fallback, multi-hop, retained-time physical gates, remaining Wi-Fi/Map/BLE/display/radio acceptance, WP-07, WP-11, admin, and final release closure remain open |
| Release status | not ready to tag; the `eaea26f` dry audit SHA-256 `e7f4952429bdb8efd2e0f6c9da1bc5afa172f6d77e0c4392be1da940ec055c46` is fail-closed with 33 P0 / 35 overall |
