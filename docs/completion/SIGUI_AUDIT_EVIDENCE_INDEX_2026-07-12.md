...
| Item | Value |
|---|---|
| Last strict-verified merged checkpoint | `0a23bb6042af5de7f1c52297b1a7089e459e52b7` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Active PR stack | No open pull requests at this snapshot; PRs #113-#118 are merged and exact-main evidence is banked through #118 |
| Candidate integration state | PRs #62, #64, #80, #84-#99, and #101-#118 are merged at the strict-verified checkpoint; exact evidence is banked through partial WP-05, WP-06, WP-07, WP-08, WP-09, WP-11, and WP-14 slices, while complete semantic/runtime/UI ownership, WP-07 RF/DM/recovery/UI/physical acceptance, WP-11 schema/reset/power-loss/write-amplification/physical durability, channel runtime/UI/RF integration, admin, TRACE, RF, and physical closure remain open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29370050844` passed 1,011 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | Five ZIPs / 46 entries strict-verified across 219 files / 73,669,010 bytes with valid provenance and SPDX; strict receipt SHA-256 `266f49e6420c83834928fc32aff03864cd2b9b0fe5d5d3fef6892d810f9e82ca` |
| Conformance closure | false; the durable channel data model, bounded Packet controller, runtime-owned truthful DM-delivery boundary, and shared retained scheduler/deadline boundary are banked as partial slices, while WP-07 exact-candidate RF/DM/recovery/UI/physical acceptance, WP-11 schema/reset/power-loss/write-amplification/physical durability, channel runtime/UI/interoperability/RF, remaining UI ownership, BLE/on-device QR, official-client/reboot/physical contact acceptance, concrete admin dispatch, generic contact/multi-hop TRACE, real-peer RF, and physical proof remain |
| Release status | not ready to tag; exact checkpoint audit SHA-256 `874f2260c4ff266ec7d9dbc0e64d3b61e123ceee5e0aafdd9864c8281193f0ed` is fail-closed with 33 P0 / 35 overall |
