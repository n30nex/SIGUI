...
**Audit date:** 2026-07-12; live reconciliation refreshed 2026-07-15
...
| Item | Value |
|---|---|
| Live merged main | `3017179bfe0cc5c7f4609a9ca5d5b88b3d229618`; exact-main Actions `29430568642` and strict receipt `5a13322b075bef165ae5a62fa250755ac50cc3b57ef45d0be68e33c559eebc4d` green; PR #144 compose evidence is owned separately and is not included in this pack |
| Last strict-verified merged checkpoint included in this pack | `c61978fd3acb738e68cd225d7b74825242757358` / Actions `29429249436` / receipt `378270da5077a7d991ad72ad2d07dd318f8adb2f308f7147553e1e1e976ef38f` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#142 are merged and strict-banked where applicable; PR #142 banks truthful DM conversation projection as the fourth partial WP-15 slice, PR #140 banks strict UTF-8 text admission, PR #139 banks the Messages root/Public chat hierarchy, PR #137 banks the direct-message controller, and PR #136 completed the planned WP-14 hierarchy/controller extraction in code. PR #144 is merged and exact-main strict-green, with its compose evidence bank owned separately |
| Candidate integration state | Live main includes PR #144 compose eligibility on top of exact evidence through PR #142: one newest-first DM row per exact contact, per-conversation unread truth across visible rows, muted-unread separation, and the durable-ring-plus-volatile-tail read-state boundary atop strict printable UTF-8 admission and the earlier partial WP-15 slices. Curated emoji/glyph coverage, remaining search/degraded/failure/retry and badge/incoming-event flows, UI-task/lifecycle/1,000-transition/exact-device acceptance, controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, live BLE/display/radio behavior, remaining Wi-Fi and Map lifecycle/live acceptance, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Last banked host suite | Exact-main Actions `29429249436` passed 1,103 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Last banked candidate CI | At exact main `c61978f`, five ZIPs / 46 entries strict-verified across 240 files / 75,534,517 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `378270da5077a7d991ad72ad2d07dd318f8adb2f308f7147553e1e1e976ef38f` |
| Conformance closure | false; live main PR #144 compose eligibility is exact-main strict-green but its evidence is owned separately and is not included in this pack, while this pack banks PR #142 as the fourth partial WP-15 truthful DM conversation-list slice atop PR #140 strict UTF-8 admission, PR #139 Messages root/Public chat, and PR #137 direct-message controller software. Remaining Messages UX, exact-candidate UI-task/lifecycle/transition/physical acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; live-main audit SHA-256 `fff6d369daccc86eee1128565982492ed1d2be0a0283085a2f8d51d88bbe5b42` is fail-closed with 33 P0 / 35 overall |
...
- Live main then advanced through PR #144 to `3017179bfe0cc5c7f4609a9ca5d5b88b3d229618`. Exact-main Actions `29430568642` strict-pass 1,107 host plus 32 checksum tests, five ZIPs / 46 entries across 258 files / 76,167,860 bytes, conformance/fuzz, exact-source provenance, and SPDX; strict receipt SHA-256 is `5a13322b075bef165ae5a62fa250755ac50cc3b57ef45d0be68e33c559eebc4d`. PR #144 compose evidence is owned separately and is not included in this pack, so this PR #142 aggregate remains exactly bound to `c61978f`; no PR #144 feature, hardware, RF, WP-15, or release closure is claimed here.
