...
| Item | Value |
|---|---|
| Live merged main | `0980cc8f8142320b014f9a78cae9cd125f430bcc`; exact-main Actions `29393666190` green |
| Last strict-verified merged checkpoint included in this pack | `0980cc8f8142320b014f9a78cae9cd125f430bcc` / Actions `29393666190` / receipt `a912e8d48fab7764e69d2abd053a3623ae257f1b4c7d1c9be61343c367014619` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#140 are merged and strict-banked; PR #140 banks strict UTF-8 text admission as the third partial WP-15 slice, PR #139 banks the Messages root/Public chat hierarchy, PR #137 banks the direct-message controller, and PR #136 completed the planned WP-14 hierarchy/controller extraction in code |
| Candidate integration state | Exact evidence through PR #140 adds strict printable UTF-8 admission and truthful character/byte compose eligibility atop the partial WP-15 Messages root/Public chat and direct-message software slices, completed planned WP-14 hierarchy/controller code, banked WP-12, and partial WP-13 slices. Curated emoji/glyph coverage, no-route/contact UI eligibility, remaining Messages UX, UI-task/lifecycle/1,000-transition/exact-device acceptance, controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, live BLE/display/radio behavior, remaining Wi-Fi and Map lifecycle/live acceptance, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29393666190` passed 1,098 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | At exact main `0980cc8`, five ZIPs / 46 entries strict-verified across 240 files / 75,511,473 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `a912e8d48fab7764e69d2abd053a3623ae257f1b4c7d1c9be61343c367014619` |
| Conformance closure | false; PR #140 adds partial WP-15 strict UTF-8 admission, PR #139 adds Messages root/Public chat software, PR #137 adds the direct-message controller, and PR #136 completes planned WP-14 hierarchy/controller code. Remaining Messages UX, exact-candidate UI-task/lifecycle/transition/physical acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; exact-main audit SHA-256 `ff8b8de3698f0f24e9391214689ef164b8a913c890afacdd96fb2dc1e406571c` is fail-closed with 33 P0 / 35 overall |
