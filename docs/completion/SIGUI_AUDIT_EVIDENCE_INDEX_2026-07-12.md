...
| Item | Value |
|---|---|
| Live merged `main` | `10d85ee3a0941aff23f455047358805a861b571e` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Active PR stack | PR #113 is this evidence-only refresh; PR #112 is merged and no later firmware PR is claimed here |
| Candidate integration state | PRs #62, #64, #80, #84-#99, and #101-#112 are merged; exact combined-main evidence is banked through partial WP-05, WP-06, WP-07, WP-08, and WP-14 slices, while complete semantic/runtime/UI ownership, remaining contact lifecycle, admin, TRACE, RF, and physical closure remain open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29359402515` passed 977 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | Five ZIPs / 46 entries strict-verified across 219 files / 73,155,041 bytes with valid provenance and SPDX; strict receipt SHA-256 `53e07c470b01a46ffcc2414c4e5b9867da9932b11203259a3d0e4e48cd3f78dc` |
| Conformance closure | false; exact-main identity, verified-advert binding, and the first canonical contact-lifecycle slice are banked, while BLE/on-device QR, official-client/reboot/physical contact acceptance, concrete admin dispatch, generic contact/multi-hop TRACE, real-peer RF, and physical proof remain |
| Release status | not ready to tag; exact live-main audit SHA-256 `fb963403f7c853210c9ae0d81dbdd840c7c5c17d62a9fe15cd571433de1e8f3e` is fail-closed with 33 P0 / 35 overall |
