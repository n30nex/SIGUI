...
| Item | Value |
|---|---|
| Live merged main | `840ae4874ad204d8fe13a29ca2e832fc0961d155`; exact-main Actions `29391670113` green |
| Last strict-verified merged checkpoint included in this pack | `840ae4874ad204d8fe13a29ca2e832fc0961d155` / Actions `29391670113` / receipt `d513bed9bb647a48a01bf57ce7266f99e55a755602ca645d4d479b0940143c0d` |
| WP-01 exact source candidate | `092293f2311a24c9899bc9bf343ab014c4ba0411` |
| Open pull requests | none |
| Merged completion slices | PRs #123-#139 are merged and strict-banked; PR #139 banks the Messages root/Public chat hierarchy as the second partial WP-15 slice, PR #137 banks the direct-message controller, and PR #136 completed the planned WP-14 hierarchy/controller extraction in code |
| Candidate integration state | Exact evidence through PR #139 adds the partial WP-15 Messages root/Public chat and direct-message software slices atop completed planned WP-14 hierarchy/controller code, banked WP-12, and partial WP-13 slices. Remaining Messages UX, UI-task/lifecycle/1,000-transition/exact-device acceptance, controlled-peer route/TRACE, multi-hop/RF, retained-wall/time physical, live BLE/display/radio behavior, remaining Wi-Fi and Map lifecycle/live acceptance, physical SD/UI, and release closure stay open |
...
| SDK | ESP-IDF 5.5.4 |
| Candidate host suite | Exact-main Actions `29391670113` passed 1,094 host and 32 checksum-contract tests, 1,008 wire vectors, 931 oracle checks, and 100,000 wire plus 100,000 advert fuzz inputs with zero findings |
| Candidate CI | At exact main `840ae48`, five ZIPs / 46 entries strict-verified across 228 files / 75,037,120 bytes with exact-source provenance and SPDX; strict receipt SHA-256 `d513bed9bb647a48a01bf57ce7266f99e55a755602ca645d4d479b0940143c0d` |
| Conformance closure | false; PR #139 adds partial WP-15 Messages root/Public chat software, PR #137 adds the direct-message controller, and PR #136 completes planned WP-14 hierarchy/controller code. Remaining Messages UX, exact-candidate UI-task/lifecycle/transition/physical acceptance, controlled-peer route/TRACE, real RF fallback, multi-hop, reboot/physical acceptance, retained wall/migration/timezone/time physical gates, remaining threat-model/live Wi-Fi and Map lifecycle acceptance, live BLE/display/radio behavior, WP-07 RF/DM recovery/UI, WP-11 durability, channel runtime/UI/interoperability, and admin remain open |
| Release status | not ready to tag; exact-main audit SHA-256 `92adbc860f13b825263538c478c95a1eea17724a0342144c06c38d74dff2598a` is fail-closed with 33 P0 / 35 overall |
