...
**Validated:** 2026-07-14 (post-PR #93/#94 reconciliation)

**Live `main`:** `b49a7b3a18379fdb6e4fe95c46784e8e2ea79d2e`
...
- PRs #62, #64, #80, #84-#94 are merged. PR #94 head `be36fe10b1ac34966b83f2a73d43d17df9f7d2c7` merged as `2b878566d846f4db68ddb40f853cc63148f4a024`; PR #93 head `e0f44a20fe52c795189c3bc40f0c17238aa764e2` then merged as live main `b49a7b3a18379fdb6e4fe95c46784e8e2ea79d2e`. Draft PR #95 banks their exact receipts while the production/oracle Ed25519 integration and ACK dispatch slices proceed independently.
...
- The latest dry audit remains fail-closed with 32 P0 failures and 34 failures overall; `ready_for_public_release` is false. The count reflects deliberately expanded exact-input and physical-evidence gates, not a regression in the two merged WP-04 slices.
