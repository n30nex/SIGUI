...
Hardware success must include a current COM12 `ui_capture_d1l.py` PNG for display pixels plus manual touch confirmation until touch automation is expanded.
