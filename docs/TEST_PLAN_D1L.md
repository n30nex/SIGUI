...
PRs #62, #64, #80, and #84-#97 are merged on verified checkpoint `ee520984d2209ae7419c02bb46d57c1549eeb56c`. Exact merged-main Actions `29313013731` passed 935 host plus 32 checksum-contract tests and the Actions-only ESP32 build; all five downloaded API ZIPs and 46 manifest entries strict-passed across 219 files / 72,428,299 bytes. The production/oracle/signed-runtime Ed25519 boundary reports 864 vectors, 100,000 fuzz inputs, 215 reviewed transformations, 256 byte-identical differential cases, `full_ubsan_clean=true`, and zero exceptions/errors. Its tracked aggregate is `docs/completion/evidence/wp04/production_oracle_ed25519_integration_83a811247aa79a379ee810da7489c90c62112fee.json` (SHA-256 `d75c1f948784faecb07b49ed423732542e91bc3947f68e76f831dad0413521f2`). The exact IDF-version aggregate is `docs/completion/evidence/wp24/idf_version_receipt_ee520984d2209ae7419c02bb46d57c1549eeb56c.json` (SHA-256 `f21abb17403f432c17bf19cc052cd185b05a39c705a3a984e73f5fcb6a547fa5`). Draft PR #98 exact head `d44e9c95f8e2b5a03366ab905782e6170057d606` is the current schema-v5 ACK durability boundary; its local exact suite passed 935 tests with three intentional skips and independent focused review passed 27 tests, but only exact successful Actions artifacts can make it mergeable. Exact-head Actions dispatch `29296995585` remains the pinned RP2040 build checkpoint, with 9 manifests / 81 entries. The complete WP-02 runtime integration baseline remains `4ee07caf` / `29290978741`; it still fails closed only for five absent frozen-candidate physical roles. WP-03 comparison acceptance passed: exact-source full-release runs `29300805114` and `29300806682` each strict-verified 9 manifests / 89 entries / 257 files, and exact comparator receipt `babb5d8c42133ab2e0d42fc38633fbba9976c17cfd42de1eb05b5559253ac11f` reports `reproducible=true` with no failures. Preserve `a03bdb8112bc309a64ea185d2d29e7a09a8e41a282dd8fc22e2b466c9218a31e` as fixed negative history; use the tracked portable aggregate at `docs/completion/evidence/wp03/release_reproducibility_e79fb56160914f4483515f4f70998aa2f8961496.json` (SHA-256 `ff97327ae7a6c7e90f2db8905ffe344dbe73d0fb75065bbf6f66294b5c72e264`) for closure.
