...
production bridge, runs COM12 raw diagnostics plus file/export/map/retained/reboot
SD canaries, and writes the final release-gate audit under `artifacts\release-gate`.
For ESP32/UI-only fixes, keep the RP2040 side completely out of the run:
