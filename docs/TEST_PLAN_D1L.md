...
PRs #62, #64, #80, #84, #85, #86, #87, #88, and #89 are merged on live `main` `5a4e7f2777b306ad4d7b62311fd79296d7d45747`. Exact merged-main Actions `29299321770` passed 845 host plus 25 checksum-contract tests, and all five downloaded artifacts strict-passed 3 manifests / 41 entries across 210 files; RP2040 correctly skipped on merged main. Exact-head Actions dispatch `29296995585` executed the pinned Arduino action, built all three RP2040 variants, and strict-passed 9 manifests / 81 entries. The complete WP-02 runtime integration baseline remains `4ee07caf` / `29290978741`; it still fails closed only for five absent frozen-candidate physical roles. WP-03 comparison acceptance requires two independent exact-source full-release packages to pass package/SBOM/provenance validation and compare reproducibly. Preserve `a03bdb8112bc309a64ea185d2d29e7a09a8e41a282dd8fc22e2b466c9218a31e` as the negative `invalid_sbom` receipt for `8b7b2c0368216bfe2f945d93323384ff6a10d7db` runs `29299613481` / `29299614693`; do not count the `f731e465bb5dc31cb1a8a88a82dafda1e3c38577` POSIX-order fix until replacement comparison and merge receipts pass.
