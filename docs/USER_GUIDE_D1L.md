...
- More groups Tools, Connections, Storage & maps, Device, Support, and Advanced into simple menus. SD Card opens a quiet Storage page with separate Card status and Data locations subpages; the other leaves remain Wi-Fi, BLE, Radio, Map Tiles, Display, Identity, Diagnostics, About, and Packets.
...
- `ui scroll-probe <...|mesh_roles|mesh_rooms|mesh_repeaters|storage|storage_card|storage_data|...>` (safe read-only page-open aliases for capture)
- `messages public`
