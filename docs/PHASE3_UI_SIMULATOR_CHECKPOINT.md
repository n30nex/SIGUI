...
- The simulator renders PNGs for Home, Messages, Nodes, Packets, Settings, compose/contact/DM/route/packet/mesh-role sheets, lock overlay, and first-boot onboarding.
