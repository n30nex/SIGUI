...
- [x] Host tests pass for current merged `main` and the standalone PR #64 rehearsal.
...
- [x] WP-01 exact-pair source qualification is `hardware_green` / `proof_banked=true` on `092293f2311a24c9899bc9bf343ab014c4ba0411`; its proof ledger is banked on `main`, but PR #80's implementation is not merged. Actions `29272708844` / `29272709642` are green; the Actions host job reports 773 passed and all 8 manifests / 78 entries verify. Canonical SHA-256 receipts: provenance `2decf8ad60b73e71bbb09b489adba8fd827856a8daf00c376c5a9ba5354e451e`; inserted stability `a038ee7ca371c4ee404493c721a343ef54e7bbd55b08273c8dc833d9d0203aef`; 10/10 removal/reinsert `3a3882038fec2497529d281f3c2b9b7468c1e62dcca7962ca3b9492125f0fad1`; 5/5 reboot matrix `db6cab3020bfa8ef575bd6a59c61d1277a8e72e1e73eb987248817199797a986`; active soak `caf19395d0e1a175f6fa13c2550bc8693297661756bf339ba4acec63da2699b9`; aggregate `994f4e5ac7b9e0e8bdb57aad7715f52a99294a1841847860e2ce2f70bd6e2277`.
- [x] PR #83 merged the refreshed completion ledger and banked WP-01 proof on `c3f9106ea9b88c491889cd8dea9ad883a0d72180`. Actions `29285852443` passed 388 host tests; both downloaded checksum manifests and all 35 entries verify, and the ledger receipt selected WP-02 as runnable. PR #62 is now merged on live `main` `570a94ad6ead0941f7acb7d9c9812c63df869e33`.
- [ ] Close `BLK-WP02-RELEASE-MANIFEST-COVERAGE-20260713`: exact-main Actions `29286754864` passed, but downloaded recursive verification found the top release manifest omitted the three nested RP2040 `SHA256SUMS.txt` files. Require PR #64's root-only exclusion, package regression, both exact workflows, and fully verified downloaded top/nested manifests before merge.
- [ ] WP-02 stack landing is in progress. Retarget and land PR #64, then PR #80, with fresh remote exact-head Actions and checksum verification at each layer. Their predecessor local-only rehearsals were PR #64 `c5886de1e2988b2097034183d5e39bb3aec88344` (575 full / 128 focused) and PR #80 `341a3abf4db4c52acf5859e396f25e7adb4cbab1` (787 / 302); those SHAs are not remote exact checks or hardware proof.
