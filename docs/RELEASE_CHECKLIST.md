...
- [ ] Fresh current-commit targeted UI corruption probe, compose-keyboard capture, scroll probe, full RF/DM acceptance, remaining physical SD release matrix, physical photos/manual UI review, and 12-hour soak still required before public release.
