...
- [x] Retained blob-store abstraction can use the RP2040 SD file protocol for the packet-log canary when a ready card reports file operations and atomic rename; NVS remains mirrored as fallback.
