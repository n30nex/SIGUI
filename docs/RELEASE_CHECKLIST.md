...
- [x] NVS-only retained blob-store abstraction added and packet-log persistence routed through it without changing the existing `d1l_packets`/`ring` data location.
